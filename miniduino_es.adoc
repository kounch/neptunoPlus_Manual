...
|===
|image:img/MiniduinoBack.jpg[scaledwidth=100%]
image:img/MiniduinoFront.jpg[scaledwidth=100%]
|image:img/MaxduinoR.jpg[scaledwidth=100%]
image:img/Maxduino.jpg[scaledwidth=100%]
image:img/MaxduinoL.jpg[scaledwidth=100%]
|===
...
[role="center",width="60%",cols="1a,1a", frame=none, grid=none]
|===
|image:img/MiniduinoLogo.jpg[scaledwidth=100%]
|image:img/MaxduinoLogo.jpg[scaledwidth=100%]
|===

Si se pulsa directamente el botón de control (o el botón `Root` en el caso de Maxduino), se accede al menú de opciones que permite modificar lo siguiente:
...
[role="center",width="30%",cols="1a", frame=none, grid=none]
|===
|image:img/MiniduinoVersion.jpg[scaledwidth=100%]
|===
...
[role="center",width="30%",cols="1a", frame=none, grid=none]
|===
|image:img/MiniduinoPlay.jpg[scaledwidth=100%]
|===
...
- En el caso de Miniduino, presionar directamente el botón de control permite activar o desactivar el modo turbo para MSX
...
Existen varios modelos de Miniduino y Maxduino, basados en el microcontrolador STM32, en ATMega328P y en ATMega32u4.
...
|===
|image:img/usbasp.jpg[scaledwidth=100%]
|===
...
|===
|image:img/usbasp_2.jpg[scaledwidth=100%]
|===
...
Una vez instalado, se ha de añadir las bibliotecas de software SDFat (1.1.4) y SoftI2CMaster eligiendo la opción de menú Programa->incluir librería->administrar bibliotecas
...
Modificar el fichero `configs.h` quitando el comentario `// #define CONFIGFILE 7` y eligiendo la opción 8
...
Conectar el Maxduino (o Miniduino) al equipo usando el cable USB e identificar el puerto asignado, normalmente con un nombre del tipo "Arduino Leonardo".

Configurar en el menú "Herramientas" las opciones

Finalmente, pulsar el botón de carga del firmware y esperar unos segundos mientras se compila el proyecto y se carga en el dispositivo.

Si todo se ha hecho correctamente se verá cómo el Maxduino (o Miniduino) se reinicia y en la pantalla aparece la versión correspondiente de firmware.
